    ...
    <div class="hp-100">
        <div class="q-mt-md hp-96" :class="{ 'q-px-sm' : $q.screen.gt.sm }">
            ...
            <q-tab-panels class="hp-93 overflow-auto bg-transparent q-pt-md" v-model="tab">
                <q-tab-panel name="fiat" class="q-pb-none flex column justify-between q-px-none">
                   <div>
                       ...
                       <p class="q-mt-lg q-mx-xs text-nv-light-tertiary" :class="{ 'fs-12' : $q.screen.gt.sm, 'fs-10' : $q.screen.lt.md }" v-text="$t('transactions.deposit.byPressingContinue')" />
                       <q-item
                           clickable
                    ...
                    <div :class="{ 'q-mt-xl' : $q.screen.lt.md, 'q-px-sm' : $q.screen.gt.sm }"
